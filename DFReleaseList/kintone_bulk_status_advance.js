(function() {
  ...
  function buildConfirmMessage(groups, skippedCount) {
    var lines = ['表示中のレコードを一括でステータスを更新します。\n'];
    var totalTarget = 0;
  ...
  kintone.events.on('app.record.index.show', function(event) {
    console.log('[INIT] 一括ステータス更新スクリプト読み込み');
    ...
    button.addEventListener('click', function() {
      ...
      console.log('[INFO] 一括ステータス更新ボタン押下');
    ...
    console.log('[INIT] 一括ステータス更新ボタンを追加しました');
    return event;
  });
})();
